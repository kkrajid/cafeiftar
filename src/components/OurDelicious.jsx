...
function OurDelicious({ dishes }) {
  return (
    <section id="our-delicious" className="p-6 bg-gray-100">
      <h2 className="text-3xl font-bold mb-4 text-center">Our Delicious Dishes</h2>
