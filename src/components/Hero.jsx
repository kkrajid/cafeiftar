          ...
          <div className="relative flex flex-col justify-center h-full text-white p-4 sm:p-6 md:p-8 lg:p-16">
            <div className="w-full max-w-xl mx-auto md:mx-0 md:ml-8 lg:ml-16 xl:ml-24 text-center md:text-left">
              <motion.h3
                ...
                className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#E0CA3C] font-medium tracking-wide mb-2 sm:mb-3 md:mb-4"
              >
              ...
              <motion.p
                ...
                className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-200 mb-4 sm:mb-5 md:mb-6 max-w-md"
              >
              ...
              <motion.button
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1 }}
                className="bg-[#E0CA3C] text-black py-3 px-8 rounded-full text-base sm:text-lg font-semibold hover:bg-[#c4b034] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[#E0CA3C] focus:ring-opacity-50 shadow-lg"
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all duration-300 ${
              index === currentIndex ? 'bg-[#E0CA3C]' : 'bg-white bg-opacity-50'
            }`}
            onClick={() => {
